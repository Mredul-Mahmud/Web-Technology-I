...
<body class="Body">
    <div >
    <form action="../Controllers/PersonalInfoValidation.php" method="post" class="PersonalInfoForm" novalidate onsubmit ="return isValid(this)">
    <table>
        <tr>
            <td>
            ...
            <input class ="PersonalInfoField" type="text" name="LastName" id="LastName" placeholder="Lasst Name"><br><br>
            ...
            <input class ="PersonalInfoField" type="text" name="FatherName" id="FatherName" placeholder="Father Name"><br><br>
    ...
    <input class="btn" type="submit" name="submit" id ="submit" value="Done"><br><br>
